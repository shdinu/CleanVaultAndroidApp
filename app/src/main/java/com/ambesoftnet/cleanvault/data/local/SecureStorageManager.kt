 ...
 * ```xml
 * <!-- /data/data/com.ambesoftnet.cleanvault/shared_prefs/regular_prefs.xml — DANGEROUS! -->
 ...
 * class for the whole app, and injects it wherever it is needed (e.g., [com.ambesoftnet.cleanvault.data.repository.NoteRepositoryImpl]).
 *
