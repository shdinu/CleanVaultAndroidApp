 ...
 *
 * | Field | [NoteDto] (API) | [com.ambesoftnet.cleanvault.domain.model.Note] (Domain) |
 * |---|---|---|
 ...
 *
 * The conversion from [NoteDto] → [com.ambesoftnet.cleanvault.data.local.NoteEntity]
 * happens in [com.ambesoftnet.cleanvault.data.repository.NoteRepositoryImpl].
 *
 * ---
 *
 ...
 * @see com.ambesoftnet.cleanvault.domain.model.Note
 */
data class NoteDto(
     ...
     * Note: This is renamed to `content` when converted to the domain [com.ambesoftnet.cleanvault.domain.model.Note].
     */
    val body: String
)
