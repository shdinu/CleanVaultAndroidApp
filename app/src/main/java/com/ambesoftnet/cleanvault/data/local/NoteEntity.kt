package com.ambesoftnet.cleanvault.data.local
 ...
 * | [com.ambesoftnet.cleanvault.data.remote.NoteDto] | Data Layer | Represents the JSON API response. |
 * | [com.ambesoftnet.cleanvault.domain.model.Note] | Domain Layer | Pure business model. No framework annotations. |
 *
