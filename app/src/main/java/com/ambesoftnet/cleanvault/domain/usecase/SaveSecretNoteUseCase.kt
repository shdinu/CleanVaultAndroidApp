 ...
 * - Which encryption algorithm is used (AES-256 — that's [com.ambesoftnet.cleanvault.data.local.SecureStorageManager]'s job).
 * - How the ViewModel triggers this (that's [com.ambesoftnet.cleanvault.presentation.notes.NotesViewModel]'s job).
 * - Where the data is stored (that's [com.ambesoftnet.cleanvault.data.repository.NoteRepositoryImpl]'s job).
 *
 * ---
 *
 ...
 *
 * @see NoteRepository
 * @see com.ambesoftnet.cleanvault.presentation.notes.NotesViewModel.onSaveSecret
 * @see GetNotesUseCase
 */
