package com.example.cleanvault.domain.repository
 ...
 *
 * In production: Hilt injects [com.example.cleanvault.data.repository.NoteRepositoryImpl].
 ...
 * @see com.example.cleanvault.domain.usecase.SaveSecretNoteUseCase
 */
interface NoteRepository {
     ...
     * 1. HTTP GET → parse JSON → [List] of [com.example.cleanvault.data.remote.NoteDto]
     * 2. Map DTOs → [com.example.cleanvault.data.local.NoteEntity] objects
     ...
     *
     * The implementation uses [com.example.cleanvault.data.local.SecureStorageManager]
